...
export function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#FFFDF5]">
      {isAuthenticated && (
        <nav className="sticky top-0 w-full h-20 border-b-4 border-black bg-white/80 backdrop-blur-md z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`py-12 md:py-24 flex flex-col items-center text-center space-y-12 ${isAuthenticated ? 'pt-20 md:pt-32' : ''}`}>
          <motion.div

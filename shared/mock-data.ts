import { User, Dog, Booking, Invoice } from './types';
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Alex Barker', email: 'alex@paws.com', role: 'client' },
  { id: 'u2', name: 'Sam Admin', email: 'sam@paws.com', role: 'admin' }
];
export const MOCK_DOGS: Dog[] = [
  { 
    ...
    instructions: 'Loves belly rubs and chasing tennis balls.' 
  },
  { 
    id: 'd2', 
    ownerId: 'u1', 
    ...
    vaccinesUpToDate: true, 
    behavior: 'shy', 
    diet: 'Standard adult kibble', 
    instructions: 'Can be nervous around loud trucks.' 
  }
];
